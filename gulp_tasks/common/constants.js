...
module.exports = function() {
    ...
    var constants = {
        ...
        fonts: {
            src: ['./' + clientFolder + '/fonts/*.*', './' + clientFolder + '/fonts/{{targetName}}/**/*.*', './bower_components/mdi/fonts/*.*'], // you can also add a specific src_appname
            dest: 'fonts'
        },
        html: {
        ...
        style: {
            ...
            css: {
                src: ['./bower_components/famous-angular/dist/famous-angular.css', './bower_components/angular-material/angular-material.css', './bower_components/mdi/css/materialdesignicons.min.css'] // you can also add a specific src_appname
            }
        },
        ...
        serve: {
            ...
            localtunnel: false // true, false or 'shakespeare-forum'
        },
        mocha: {
            libs: ['server/**/*.js'],
            tests: ['test/mocha/**/*.js'],
